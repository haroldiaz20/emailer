 ...
 */
class CampaignListChip extends React.Component {
  ...
  componentDidMount(){
    this.setState({chipData: this.props.listsData});
  }
  ...
  handleRequestDelete = (key) => {
    ...
    this.props.onUnselect(this.chipData);
...
export default CampaignListChip;